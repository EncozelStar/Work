...
local Themes = {
	...
	Darker = {
		...
		ToggleToggled = Color3.fromRGB(235, 100, 100),
	...
	Armon = {
	    ...
	    AcrylicMain = Color3.fromRGB(0, 0, 0),
	    AcrylicBorder = Color3.fromRGB(90, 70, 130),
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0),Color3.fromRGB(40, 30, 60)),
	    AcyclicNoise = 1,
	    TitleBarLine = Color3.fromRGB(0, 0, 0),
	    Tab = Color3.fromRGB(200, 190, 255),
	    Element = Color3.fromRGB(200, 190, 255),
	    ElementBorder = Color3.fromRGB(90, 70, 130),
	    InElementBorder = Color3.fromRGB(90, 70, 130),
	    ElementTransparency = 0.86,
	    ToggleSlider = Color3.fromRGB(200, 190, 255),
	    ToggleToggled = Color3.fromRGB(120, 100, 180),
	    SliderRail = Color3.fromRGB(170, 160, 220),
	    DropdownFrame = Color3.fromRGB(200, 190, 255),
	    DropdownHolder = Color3.fromRGB(0, 0, 0),
	    DropdownBorder = Color3.fromRGB(40, 30, 60),
	    DropdownOption = Color3.fromRGB(200, 190, 255),
	    Keybind = Color3.fromRGB(200, 190, 255),
	    Input = Color3.fromRGB(200, 190, 255),
	    InputFocused = Color3.fromRGB(40, 30, 60),
	    InputIndicator = Color3.fromRGB(180, 170, 240),
	    Dialog = Color3.fromRGB(0, 0, 0),
	    DialogHolder = Color3.fromRGB(0, 0, 0),
	    DialogHolderLine = Color3.fromRGB(0, 0, 0),
	    DialogButton = Color3.fromRGB(160, 140, 210),
	    DialogButtonBorder = Color3.fromRGB(40, 30, 60),
	    DialogBorder = Color3.fromRGB(40, 30, 60),
	    DialogInput = Color3.fromRGB(200, 190, 255),
	    DialogInputLine = Color3.fromRGB(255, 240, 255),
	    Text = Color3.fromRGB(255, 255, 255),
	    SubText = Color3.fromRGB(180, 170, 190),
	    Hover = Color3.fromRGB(220, 210, 255),
	    HoverChange = 0.04
	}
